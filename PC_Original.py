...
This code roughly follows the approach of the paper below,
 binarizing an image and then computing the CMI of that binarization:
[2] A. Shaus, S. Faigenbaum-Golovin, B. Sober, and E. Turkel, “Potential
contrast–a new image quality measure,” Electronic Imaging, vol. 29,
pp. 52–58, 2017.
...
PC = np.mean(mappedClassesImageRange[maskArrs[1]]) - np.mean(mappedClassesImageRange[maskArrs[0]])
